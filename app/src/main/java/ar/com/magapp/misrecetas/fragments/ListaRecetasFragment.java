 ...
 * {@link ListaRecetasFragment.OnFragmentInteractionListener} interface
...
public class ListaRecetasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_lista_recetas, container, false);

        listaRecetas = new ArrayList<>();
        recyclerRecetas = (RecyclerView) vista.findViewById(R.id.idRecyclerRecetas);
        recyclerRecetas.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        if (objetoCategoria != null) {
            ...
            adapter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(getContext(), "Seleccion: " + listaRecetas.get(recyclerRecetas.getChildAdapterPosition(view)).getNombre(), Toast.LENGTH_SHORT).show();
                    interfazcComunicacionFragment.enviarReceta(listaRecetas.get(recyclerRecetas.getChildAdapterPosition(view)));
                }
            });
        }
        return vista;
